...
(function(global) {
    ...
    jQuery.fn = jQuery.prototype = {
        ...
        init: function(selector, context) {
            ...
            if (typeof selector === 'string') {
                ...
                // Handle element creation like $('<div/>')
                if (selector.charAt(0) === '<' && selector.charAt(selector.length - 1) === '>' && selector.length >= 3) {
                    var tagMatch = selector.match(/<(\w+)(?:\s[^>]*)?(?:\/>|>.*<\/\1>)/);
                    if (tagMatch) {
                        var tagName = tagMatch[1];
                        var element = document.createElement(tagName);
                        // Simple innerHTML handling for basic content
                        ...
                        // Simple self-closing tag like <div/>
                ...
                try {
                    ...
                    // If querySelectorAll fails, return empty jQuery object
                    this.length = 0;
                }
        ...
        map: function(callback) {
            var results = jQuery();
            for (var i = 0; i < this.length; i++) {
                var result = callback.call(this[i], i, this[i]);
    ...
    jQuery.removeData = function(element, key) {
        if (elementData.has(element)) {
            var data = elementData.get(element);
            if (key) {
                delete data[key];
